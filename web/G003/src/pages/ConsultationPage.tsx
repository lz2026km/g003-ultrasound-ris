...
const CONSULTATION_DATA = [
  {
    ...
    priority: 'urgent',
    date: '2026-04-30',
    description: '胃窦部可见异常回声区，边界不清，内部回声不均匀，CDFI可见血流信号',
    slides: 8,
    mdtTeam: '胃癌MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-29',
    description: '横结肠区可见一个低回声结节，突向肠腔，CDFI可见点状血流信号',
    slides: 5,
    mdtTeam: '结直肠癌MDT',
  },
  {
  ...
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-28',
    description: '食管下段管壁局限性增厚，层次结构尚清，血流信号丰富',
    slides: 6,
    mdtTeam: '食管癌MDT',
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-27',
    description: '肝门部胆管壁不规则增厚，管腔狭窄，上游胆管明显扩张',
    slides: 9,
    mdtTeam: '胆道肿瘤MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-29',
    description: '回盲部肠壁弥漫性增厚，层次模糊，周围淋巴结肿大',
    slides: 7,
    mdtTeam: '炎症性肠病MDT',
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-30',
    description: '残胃小弯侧可见不规则低回声团块，边界不清，侵及浆膜层',
    slides: 6,
    mdtTeam: '胃癌MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-26',
    description: '胃体前壁黏膜下层可见一个低回声肿块，边界清晰，内部回声均匀',
    slides: 8,
    mdtTeam: '胃肠道间质瘤MDT',
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-29',
    description: '全结肠可见多个低回声结节，部分突向肠腔，肠壁层次尚清',
    slides: 15,
    mdtTeam: '结直肠癌MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-25',
    description: '胃角小弯侧黏膜层可见局部增厚，回声减低，固有层结构紊乱',
    slides: 7,
    mdtTeam: '胃癌MDT',
  },
  {
  ...
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-28',
    description: '小肠中段肠壁局限性增厚，血流信号丰富，肠腔未见明显狭窄',
    slides: 4,
    mdtTeam: '小肠疾病MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-24',
    description: '直肠距肛缘6cm处可见一个低回声小结节，突向肠腔，边界清晰',
    slides: 5,
    mdtTeam: '神经内分泌肿瘤MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-27',
    description: '胃底胃体黏膜层均匀性增厚，胃壁蠕动减弱，腔内可见液体潴留',
    slides: 6,
  ...
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-29',
    description: '隆突下见数枚增大淋巴结，最大约2.1×1.5cm，内部回声不均，可见液化区',
    slides: 11,
    mdtTeam: '胸部肿瘤MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-26',
    description: '回肠末端肠壁节段性增厚，肠腔狭窄，肠系膜淋巴结肿大',
    slides: 8,
    mdtTeam: '炎症性肠病MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-23',
    description: '食管中段管壁局限性增厚，黏膜层回声减低，肌层尚连续',
    slides: 5,
    mdtTeam: '食管癌MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-28',
    description: '小肠可见多处肠壁节段性增厚，肠腔狭窄，肠系膜血流信号增多',
    slides: 9,
    mdtTeam: '炎症性肠病MDT',
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-22',
    description: '十二指肠壶腹部可见不规则肿块影，胆管下端狭窄，上游胆管扩张',
    slides: 8,
    mdtTeam: '胆道肿瘤MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-25',
    description: '胃体胃底胃壁弥漫性增厚，黏膜层回声减低，胃腔狭窄',
    slides: 7,
    mdtTeam: '胃肠道淋巴瘤MDT',
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-29',
    description: '直肠可见一个较大范围的不规则增厚病变，突向肠腔，肠壁层次不清',
    slides: 12,
    mdtTeam: '结直肠癌MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-21',
    description: '胃窦黏膜层可见多个小的低回声隆起，胃壁蠕动正常',
    slides: 4,
    mdtTeam: '过敏性疾病MDT',
  },
  {
  ...
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-24',
    description: '盲肠可见一个广基低回声息肉样病变，突向肠腔，表面不光滑',
    slides: 5,
    mdtTeam: '结直肠癌MDT',
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-20',
    description: '胃窦部胃壁不规则增厚，幽门管腔狭窄，胃壁浆膜层模糊，周围淋巴结肿大',
    slides: 10,
    mdtTeam: '胃癌MDT',
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-27',
    description: '空肠上段可见一个无回声团块，边界清晰，内部透声好，CDFI可见静脉血流信号',
    slides: 6,
    mdtTeam: '小肠疾病MDT',
  },
  {
  ...
  },
  {
    ...
    priority: 'normal',
    date: '2026-04-19',
    description: '胃体后壁黏膜下层可见一个低回声肿块，边界清晰，起源于肌层',
    slides: 5,
    mdtTeam: '胃肠道间质瘤MDT',
  },
  {
    ...
    priority: 'urgent',
    date: '2026-04-29',
    description: '胃体小弯侧肿块较前缩小约40%，原瘤床区域回声减低，层次模糊',
    slides: 11,
    mdtTeam: '胃癌MDT',
  },
  {
