...
const alertRecords: AlertRecord[] = [
  { id: 'CA001', level: '红色(Ⅰ级)', type: '患者安全', title: '术中出血量超过1500ml', department: '消化内科', reporter: '李明', occurTime: '2026-04-30 07:15', responseTime: 3, status: '处置中', description: '结超声手术中突发大出血，已启动紧急输血' },
  ...
  { id: 'CA008', level: '橙色(Ⅱ级)', type: '设备故障', title: '超声清洗消毒机故障', department: '供应室', reporter: '吴磊', occurTime: '2026-04-30 07:50', responseTime: 20, status: '处置中', description: '清洗机无法升温，200条超声积压待清洗' },
  ...
  { id: 'CA011', level: '橙色(Ⅱ级)', type: '感染暴发', title: '超声室幽门螺杆菌聚集性感染', department: '消化内科', reporter: '马琳', occurTime: '2026-04-29 16:00', responseTime: 30, status: '升级处理', description: '1周内3例患者超声后出现HP感染' },
  ...
  { id: 'CA013', level: '黄色(Ⅲ级)', type: '设备故障', title: '电子超声图像偏暗', department: '消化内科', reporter: '杨洋', occurTime: '2026-04-30 09:10', responseTime: 35, status: '处置中', description: '奥林巴斯CF-HQ290超声光源衰减' },
  ...
  { id: 'CA018', level: '黄色(Ⅲ级)', type: '信息系统', title: '超声工作站加载缓慢', department: '医务科', reporter: '邓超', occurTime: '2026-04-30 07:40', responseTime: 28, status: '已化解', description: 'US系统部分模块响应超过10秒' },
  ...
  { id: 'CA031', level: '红色(Ⅰ级)', type: '患者安全', title: '超声逆行胰胆管造影术后胰腺炎', department: '消化内科', reporter: '姜涛', occurTime: '2026-04-28 20:00', responseTime: 4, status: '处置中', description: 'USCP术后患者出现重症胰腺炎' },
