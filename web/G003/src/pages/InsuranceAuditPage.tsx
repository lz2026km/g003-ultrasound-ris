...
const restrictedDrugs: RestrictedDrug[] = [
  { id: 1, name: '丙泊酚注射液', category: '麻醉用药', restriction: '限二级以上公立医疗机构使用，限短期镇静', applicableExams: '无痛腹部超声、无痛超声', notes: '需麻醉科医师在场' },
  { id: 2, name: '盐酸哌替啶注射液', category: '镇痛药', restriction: '限急性疼痛、术后镇痛及麻醉前给药', applicableExams: '急慢性疼痛、术后镇痛', notes: '需副主任医师以上开具' },
  ...
  { id: 6, name: '甘油果糖注射液', category: '脱水药', restriction: '限脱水及脑水肿治疗', applicableExams: '颅内手术前准备', notes: '需监测电解质' },
  { id: 7, name: '硫酸阿托品注射液', category: '抗胆碱药', restriction: '限有机磷中毒、缓慢型心律失常', applicableExams: '介入超声', notes: '青光眼患者禁用' },
  { id: 8, name: '肾上腺素注射液', category: '升压药', restriction: '限过敏性休克、心脏骤停、支气管痉挛', applicableExams: '腹部超声下止血、超声引导下止血', notes: '局部使用需稀释' },
  { id: 9, name: '二氧化碳气体', category: '气体', restriction: '限腔镜手术充气', applicableExams: '腹腔镜、胸腔镜', notes: '需严格掌握适应证' },
  { id: 10, name: '硝酸甘油注射液', category: '扩血管药', restriction: '限冠心病、心绞痛', applicableExams: '食管动力检查、贲门失弛缓', notes: '需心血管评估' },
  { id: 11, name: '双歧杆菌三联活菌胶囊', category: '微生态制剂', restriction: '限肠道菌群失调', applicableExams: '肠道检查后菌群调节', notes: '温水送服' },
  { id: 12, name: '肠内营养混悬液', category: '营养药', restriction: '限不能经口进食患者', applicableExams: '胃造口术、空肠造口术', notes: '需营养科会诊' },
  { id: 13, name: '甲硫酸新斯的明注射液', category: '促胃肠动力药', restriction: '限术后肠麻痹、术后尿潴留', applicableExams: '浅表超声检查', notes: '机械性肠梗阻禁用' },
  { id: 14, name: '氨甲环酸注射液', category: '止血药', restriction: '限急性或慢性局限性纤维蛋白溶解', applicableExams: '消化道出血超声下止血', notes: '需凝血功能评估' },
  { id: 15, name: '注射用矛头蝮蛇血凝酶', category: '止血药', restriction: '限出血性疾病', applicableExams: '肝穿刺术后', notes: '需监测凝血功能' },
  { id: 16, name: '脂肪乳氨基酸葡萄糖注射液', category: '肠外营养', restriction: '限不能经口进食且无法肠内营养者', applicableExams: '胃造口术后、空肠造口术后', notes: '需中心静脉通路' },
]
