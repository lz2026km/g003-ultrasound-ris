...
const LOWER_ABDOMINAL_MIN_PHOTOS = 20

// ========== 超声扫查切面标准数据 ==========
const UPPER_ABDOMINAL_22_STANDARD: { id: string; name: string; description: string; required: boolean }[] = [
  ...
  { id: 'U07', name: '门静脉主干切面', description: '显示门静脉主干及肝动脉', required: true },
  { id: 'U08', name: '胆囊长轴切面', description: '显示胆囊长径及胆囊壁', required: true },
  { id: 'U09', name: '胆囊短轴切面', description: '显示胆囊横径及颈部', required: true },
  { id: 'U10', name: '肝门部横切面', description: '显示门静脉及胆总管', required: true },
  { id: 'U11', name: '胰腺长轴切面', description: '显示胰头、胰体、胰尾及主胰管', required: true },
  { id: 'U12', name: '胰腺短轴切面', description: '显示胰腺各部横径', required: true },
  { id: 'U13', name: '脾脏肋间切面', description: '显示脾脏长径及脾门', required: true },
  { id: 'U14', name: '脾脏肋缘下切面', description: '显示脾脏下极', required: true },
  { id: 'U15', name: '左肾长轴切面', description: '显示左肾全长及集合系统', required: true },
  { id: 'U16', name: '左肾短轴切面', description: '显示左肾横径及皮髓质', required: true },
  { id: 'U17', name: '右肾长轴切面', description: '显示右肾全长及肾门血管', required: true },
  { id: 'U18', name: '右肾短轴切面', description: '显示右肾横径及皮髓质', required: false },
  { id: 'U19', name: '腹主动脉长轴切面', description: '显示腹主动脉及其主要分支', required: false },
  { id: 'U20', name: '下腔静脉长轴切面', description: '显示下腔静脉肝后段', required: false },
  { id: 'U21', name: '腹部大血管横切面', description: '显示主要血管横断面', required: false },
  { id: 'U22', name: '病变部位特写', description: '如有病变需特写测量', required: false },
]

const LOWER_ABDOMINAL_20_STANDARD: { id: string; name: string; description: string; required: boolean }[] = [
  { id: 'L01', name: '膀胱横切面', description: '显示膀胱横径及壁厚', required: true },
  { id: 'L02', name: '膀胱纵切面', description: '显示膀胱长径及颈部', required: true },
  { id: 'L03', name: '前列腺横切面', description: '显示前列腺横径及内外腺', required: true },
  { id: 'L04', name: '前列腺纵切面', description: '显示前列腺长径及精囊', required: true },
  { id: 'L05', name: '输尿管壁内段切面', description: '显示输尿管盆段及壁内段', required: true },
  { id: 'L06', name: '直肠前壁切面', description: '显示直肠前壁及周围组织', required: true },
  { id: 'L07', name: '精囊腺切面', description: '显示精囊腺形态及大小', required: true },
  { id: 'L08', name: '子宫横切面', description: '显示子宫横径及内膜', required: true },
  { id: 'L09', name: '子宫纵切面', description: '显示子宫长径及宫颈', required: true },
  { id: 'L10', name: '卵巢横切面', description: '显示卵巢大小及卵泡', required: true },
  { id: 'L11', name: '卵巢纵切面', description: '显示卵巢长径及回声', required: true },
  { id: 'L12', name: '双侧髂血管切面', description: '显示髂外动静脉', required: true },
  { id: 'L13', name: '阑尾区切面', description: '显示阑尾根部及周围', required: true },
  { id: 'L14', name: '腹股沟区切面', description: '显示腹股沟区淋巴结', required: true },
  { id: 'L15', name: '肠管横切面', description: '显示肠管走形及肠壁', required: true },
  { id: 'L16', name: '肠管纵切面', description: '显示肠管长轴及内容物', required: true },
  { id: 'L17', name: '腹腔积液切面', description: '如有腹水需测量深度', required: false },
  { id: 'L18', name: '腹部包块切面1', description: '如有包块需多切面显示', required: false },
  { id: 'L19', name: '腹部包块切面2', description: '包块大小及血流', required: false },
  { id: 'L20', name: '特殊部位测量', description: '根据临床需要补充', required: false },
]
