...
const mockMaterials: Material[] = [
  { id: 'M001', code: 'US-001', name: '超声耦合剂', category: '配件类', spec: '5kg/桶', unit: '把', stock: 15, alertLine: 20, expiryDate: '2027-06-15', supplier: 'GE医疗中国', status: '偏低', price: 680, lastRestockDate: '2026-03-10' },
  { id: 'M002', code: 'US-002', name: '探头清洁湿巾', category: '配件类', spec: '100片/包', unit: '个', stock: 8, alertLine: 15, expiryDate: '2027-03-20', supplier: 'GE医疗中国', status: '偏低', price: 420, lastRestockDate: '2026-02-28' },
  { id: 'M003', code: 'BJ-003', name: '注射针', category: '配件类', spec: 'NM-201L-1', unit: '支', stock: 45, alertLine: 30, expiryDate: '2026-12-31', supplier: 'Philips医疗', status: '正常', price: 85, lastRestockDate: '2026-04-01' },
  { id: 'M004', code: 'US-003', name: '探头保护膜', category: '配件类', spec: '100个/盒', unit: '枚', stock: 3, alertLine: 10, expiryDate: '2026-05-10', supplier: 'GE医疗中国', status: '告急', price: 560, lastRestockDate: '2026-01-15' },
  { id: 'M005', code: 'BJ-005', name: '导丝', category: '配件类', spec: 'M00526720', unit: '根', stock: 22, alertLine: 15, expiryDate: '2028-01-01', supplier: 'Mindray医疗', status: '正常', price: 280, lastRestockDate: '2026-03-20' },
  { id: 'M006', code: 'YP-001', name: '超声耦合剂', category: '药品类', spec: '10g:0.2g', unit: '支', stock: 120, alertLine: 50, expiryDate: '2026-06-30', supplier: '华润紫竹药业', status: '正常', price: 12, lastRestockDate: '2026-04-10' },
  { id: 'M007', code: 'YP-002', name: '导电膏', category: '药品类', spec: '20ml:0.2g', unit: '支', stock: 35, alertLine: 40, expiryDate: '2026-08-15', supplier: 'GE医疗', status: '偏低', price: 68, lastRestockDate: '2026-03-25' },
  ...
  { id: 'M009', code: 'YP-004', name: '皮肤消毒液', category: '药品类', spec: '500ml', unit: '瓶', stock: 8, alertLine: 20, expiryDate: '2026-04-25', supplier: '山东利尔康', status: '告急', price: 15, lastRestockDate: '2026-02-01' },
  ...
  { id: 'M016', code: 'US-004', name: '打印纸热敏卷', category: '配件类', spec: '50卷/箱', unit: '个', stock: 10, alertLine: 8, expiryDate: '2027-09-30', supplier: 'GE医疗中国', status: '正常', price: 380, lastRestockDate: '2026-03-15' },
  { id: 'M017', code: 'US-005', name: '超声探头护套', category: '配件类', spec: '100个/盒', unit: '根', stock: 6, alertLine: 5, expiryDate: '2027-04-15', supplier: 'Philips医疗', status: '正常', price: 1200, lastRestockDate: '2026-04-02' },
  { id: 'M018', code: 'YP-005', name: '器官润滑剂', category: '药品类', spec: '10ml:40mg', unit: '支', stock: 60, alertLine: 30, expiryDate: '2026-09-30', supplier: '自贡鸿鹤', status: '正常', price: 8, lastRestockDate: '2026-03-28' },
  ...
  { id: 'M020', code: 'YP-006', name: '除泡剂', category: '药品类', spec: '10ml:20mg', unit: '支', stock: 2, alertLine: 30, expiryDate: '2026-05-05', supplier: '自贡鸿鹤', status: '过期', price: 9, lastRestockDate: '2025-12-01' },
  { id: 'M021', code: 'US-006', name: '酒精棉球', category: '配件类', spec: '500ml/瓶', unit: '个', stock: 18, alertLine: 12, expiryDate: '2027-02-28', supplier: 'GE医疗中国', status: '正常', price: 320, lastRestockDate: '2026-04-08' },
  { id: 'M022', code: 'US-007', name: '耦合剂加热器', category: '配件类', spec: '台', unit: '个', stock: 35, alertLine: 20, expiryDate: '2028-06-30', supplier: 'GE医疗中国', status: '正常', price: 45, lastRestockDate: '2026-03-22' },
  { id: 'M023', code: 'YP-007', name: '急救药品', category: '药品类', spec: '1ml:2mg', unit: '支', stock: 50, alertLine: 30, expiryDate: '2026-12-31', supplier: '上海禾丰', status: '正常', price: 5, lastRestockDate: '2026-04-12' },
  ...
  { id: 'M026', code: 'US-008', name: '探头支架', category: '配件类', spec: '个', unit: '个', stock: 7, alertLine: 8, expiryDate: '2027-01-15', supplier: 'Philips医疗', status: '正常', price: 850, lastRestockDate: '2026-03-28' },
  { id: 'M027', code: 'YP-008', name: '急救药品', category: '药品类', spec: '1ml:0.5mg', unit: '支', stock: 80, alertLine: 40, expiryDate: '2027-06-30', supplier: '天津金耀', status: '正常', price: 3.8, lastRestockDate: '2026-04-10' },
  ...
  { id: 'M030', code: 'US-009', name: '机器表面清洁布', category: '配件类', spec: '包', unit: '个', stock: 4, alertLine: 6, expiryDate: '2027-03-10', supplier: 'Philips医疗', status: '偏低', price: 720, lastRestockDate: '2026-03-01' },
  { id: 'M031', code: 'YP-009', name: '局麻药', category: '药品类', spec: '2ml:10mg', unit: '支', stock: 40, alertLine: 25, expiryDate: '2026-10-31', supplier: '天津力生', status: '正常', price: 4.5, lastRestockDate: '2026-04-08' },
  ...
  { id: 'M034', code: 'US-010', name: '检查床一次性床单', category: '配件类', spec: '50张/包', unit: '个', stock: 25, alertLine: 15, expiryDate: '2027-08-31', supplier: 'GE医疗中国', status: '正常', price: 180, lastRestockDate: '2026-03-25' },
  { id: 'M035', code: 'YP-010', name: '止血敏', category: '药品类', spec: '2ml:10mg', unit: '支', stock: 28, alertLine: 30, expiryDate: '2026-11-30', supplier: '江苏恩华', status: '偏低', price: 38, lastRestockDate: '2026-03-15' },
  ...
  { id: 'M038', code: 'US-011', name: '防护眼镜', category: '配件类', spec: '10副/盒', unit: '个', stock: 12, alertLine: 8, expiryDate: '2027-05-31', supplier: 'GE医疗中国', status: '正常', price: 450, lastRestockDate: '2026-04-02' },
  { id: 'M039', code: 'YP-011', name: '急救药品', category: '药品类', spec: '1ml:1mg', unit: '支', stock: 65, alertLine: 40, expiryDate: '2027-01-31', supplier: '天津金耀', status: '正常', price: 4.2, lastRestockDate: '2026-04-15' },
  ...
  { id: 'M042', code: 'US-012', name: '探头消毒盒', category: '配件类', spec: '个', unit: '个', stock: 9, alertLine: 6, expiryDate: '2027-04-30', supplier: 'GE医疗中国', status: '正常', price: 580, lastRestockDate: '2026-04-05' },
  { id: 'M043', code: 'YP-012', name: '升压药', category: '药品类', spec: '5ml:0.5mg', unit: '支', stock: 22, alertLine: 15, expiryDate: '2026-12-31', supplier: '江苏恩华', status: '正常', price: 65, lastRestockDate: '2026-03-28' },
  ...
  { id: 'M046', code: 'US-013', name: '移动存储设备', category: '配件类', spec: '台', unit: '根', stock: 5, alertLine: 8, expiryDate: '2028-01-01', supplier: 'Philips医疗', status: '偏低', price: 520, lastRestockDate: '2026-03-10' },
  { id: 'M047', code: 'YP-013', name: '造影剂', category: '药品类', spec: '1ml:10mg', unit: '支', stock: 70, alertLine: 40, expiryDate: '2027-03-31', supplier: '天津力生', status: '正常', price: 3.2, lastRestockDate: '2026-04-12' },
  ...
  { id: 'M050', code: 'US-014', name: '超声工作站配件', category: '配件类', spec: '套', unit: '支', stock: 14, alertLine: 10, expiryDate: '2027-02-28', supplier: 'GE医疗中国', status: '正常', price: 290, lastRestockDate: '2026-04-08' },
  { id: 'M051', code: 'YP-014', name: '山莨菪碱', category: '药品类', spec: '1ml:10mg', unit: '支', stock: 55, alertLine: 30, expiryDate: '2027-05-31', supplier: '杭州民生', status: '正常', price: 4.8, lastRestockDate: '2026-04-10' },
  ...
  { id: 'M053', code: 'YP-015', name: '凝血酶', category: '药品类', spec: '500单位', unit: '支', stock: 18, alertLine: 15, expiryDate: '2026-10-15', supplier: '上海莱士', status: '正常', price: 85, lastRestockDate: '2026-04-02' },
  { id: 'M054', code: 'US-015', name: '穿刺针托架', category: '配件类', spec: '10支/盒', unit: '个', stock: 8, alertLine: 10, expiryDate: '2027-06-30', supplier: 'GE医疗中国', status: '偏低', price: 420, lastRestockDate: '2026-03-15' },
];

const mockUsageRecords: MaterialUsage[] = [
  { id: 'UR001', materialId: 'M001', materialName: '超声耦合剂', endoscopeId: 'EN001', endoscopeName: 'GE Voluson E10', patientId: 'P001', patientName: '王建国', examId: 'EX001', examType: '电子腹部超声检查', usageDate: '2026-04-29', usageTime: '09:05', quantity: 1, operator: '赵晓敏', notes: '胃窦活检' },
  { id: 'UR002', materialId: 'M001', materialName: '超声耦合剂', endoscopeId: 'EN001', endoscopeName: 'GE Voluson E10', patientId: 'P002', patientName: '李秀芳', examId: 'EX002', examType: '电子腹部超声检查', usageDate: '2026-04-29', usageTime: '09:35', quantity: 1, operator: '赵晓敏', notes: '胃体活检' },
  { id: 'UR003', materialId: 'M003', materialName: '超声耦合剂', endoscopeId: 'EN001', endoscopeName: 'GE Voluson E10', patientId: 'P003', patientName: '张德明', examId: 'EX003', examType: '腹部超声造影检查', usageDate: '2026-04-29', usageTime: '10:30', quantity: 1, operator: '赵晓敏', notes: '静脉曲张注射' },
  { id: 'UR004', materialId: 'M004', materialName: '探头保护膜', endoscopeId: 'EN001', endoscopeName: 'GE Voluson E10', patientId: 'P003', patientName: '张德明', examId: 'EX003', examType: '腹部超声造影检查', usageDate: '2026-04-29', usageTime: '10:45', quantity: 2, operator: '赵晓敏', notes: '止血夹闭' },
  { id: 'UR005', materialId: 'M006', materialName: '导电膏', endoscopeId: 'EN001', endoscopeName: 'GE Voluson E10', patientId: 'P004', patientName: '周丽娟', examId: 'EX004', examType: '电子腹部超声检查', usageDate: '2026-04-28', usageTime: '14:00', quantity: 1, operator: '赵晓敏', notes: '术前局麻' },
];

// 申领单数据
const mockRequisitions: Requisition[] = [
  { id: 'REQ001', materialId: 'M004', materialName: '止血夹', category: '配件类', spec: '100个/盒', unit: '枚', quantity: 10, applicant: '张护士', applicantDept: '超声中心', applyDate: '2026-04-28', reason: '库存告急，急需补充', status: '待审批' },
  { id: 'REQ002', materialId: 'M002', materialName: '圈套器', category: '配件类', spec: '100片/包', unit: '个', quantity: 20, applicant: '李护士', applicantDept: '超声中心', applyDate: '2026-04-27', reason: '库存偏低，需补充', status: '已通过' },
  ...
  { id: 'REQ004', materialId: 'M007', materialName: '丙泊酚注射液', category: '药品类', spec: '20ml:0.2g', unit: '支', quantity: 50, applicant: '赵医生', applicantDept: '超声中心', applyDate: '2026-04-29', reason: '科室常用耗材库存不足', status: '待审批' },
...
const mockInboundRecords: InboundRecord[] = [
  { id: 'IN001', materialId: 'M001', materialName: '超声耦合剂', batchNo: 'BJ20260401', quantity: 20, expiryDate: '2028-04-01', inDate: '2026-04-10', operator: '仓管员小张', supplier: 'GE医疗中国', status: '已入库' },
...
const mockPurchaseOrders: PurchaseOrder[] = [
  { id: 'PO001', materialId: 'M001', materialName: '超声耦合剂', category: '配件类', supplier: 'GE医疗中国', quantity: 50, unitPrice: 680, totalAmount: 34000, purchaseDate: '2026-04-28', purchaser: '刘伟东', status: '待采购' },
  { id: 'PO002', materialId: 'M004', materialName: '止血夹', category: '配件类', supplier: 'GE医疗中国', quantity: 30, unitPrice: 560, totalAmount: 16800, purchaseDate: '2026-04-28', purchaser: '刘伟东', status: '待采购' },
