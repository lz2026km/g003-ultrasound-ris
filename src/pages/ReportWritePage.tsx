...
// ---------- 常量 ----------
import {
  UPPER_ABDOMINAL_MIN_PHOTOS, LOWER_ABDOMINAL_MIN_PHOTOS,
  UPPER_ABDOMINAL_22_STANDARD, LOWER_ABDOMINAL_20_STANDARD,
  STRUCTURED_TEMPLATES, COMMON_PHRASES, TERM_HINTS, AI_CONTENT,
  QUALITY_CRITERIA, DIAGNOSTIC_TEMPLATES, MOCK_HISTORY_REPORTS,
} from '../data/reportConstants'
import type { ReportTemplateType } from '../data/reportConstants'
