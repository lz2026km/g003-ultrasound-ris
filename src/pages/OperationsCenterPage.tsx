...
// ==================== 模拟数据 ====================
const KPI_DATA = [
  { label: '今日检查量', value: 487, unit: '例', yesterday: 452, trend: 'up' },
  { label: '今日预约量', value: 523, unit: '例', yesterday: 498, trend: 'up' },
  { label: '在检人数', value: 38, unit: '人', trend: 'neutral' },
  { label: '等待人数', value: 142, unit: '人', trend: 'down' },
  { label: '设备利用率', value: 87.5, unit: '%', trend: 'up' },
  { label: '平均候诊时间', value: 18, unit: '分钟', trend: 'down' },
]

const ROOMS = [
  { name: '诊室1', status: '检查中', patient: '张伟', color: '#4ade80' },
  { name: '诊室2', status: '空闲', patient: '-', color: '#64748b' },
  { name: '诊室3', status: '准备中', patient: '李娜', color: '#fbbf24' },
  { name: '诊室4', status: '检查中', patient: '王芳', color: '#4ade80' },
  { name: '诊室5', status: '空闲', patient: '-', color: '#64748b' },
  { name: '诊室6', status: '检查中', patient: '刘洋', color: '#4ade80' },
]
...
const HOURLY_DATA = [
  ...
  { hour: '5', today: 2, yesterday: 1 },
  { hour: '6', today: 8, yesterday: 5 },
  { hour: '7', today: 18, yesterday: 15 },
  { hour: '8', today: 42, yesterday: 38 },
  { hour: '9', today: 68, yesterday: 62 },
  { hour: '10', today: 85, yesterday: 78 },
  { hour: '11', today: 92, yesterday: 88 },
  { hour: '12', today: 65, yesterday: 58 },
  { hour: '13', today: 72, yesterday: 65 },
  { hour: '14', today: 88, yesterday: 82 },
  { hour: '15', today: 95, yesterday: 90, peak: true },
  { hour: '16', today: 82, yesterday: 85 },
  { hour: '17', today: 68, yesterday: 72 },
  { hour: '18', today: 45, yesterday: 42 },
  { hour: '19', today: 28, yesterday: 25 },
  { hour: '20', today: 15, yesterday: 12 },
  { hour: '21', today: 8, yesterday: 6 },
  { hour: '22', today: 3, yesterday: 2 },
  { hour: '23', today: 1, yesterday: 0 },
]

const DOCTOR_RANKING = [
  { rank: 1, name: '王建国', exams: 42, reports: 38, rate: 90.5 },
  { rank: 2, name: '李秀英', exams: 38, reports: 36, rate: 94.7 },
  { rank: 3, name: '张志明', exams: 35, reports: 32, rate: 91.4 },
  { rank: 4, name: '陈晓燕', exams: 32, reports: 30, rate: 93.8 },
  { rank: 5, name: '刘德伟', exams: 28, reports: 25, rate: 89.3 },
  { rank: 6, name: '赵红梅', exams: 25, reports: 24, rate: 96.0 },
]
...
const QUALITY_DATA = [
  { label: '危急值', value: 3, icon: AlertTriangle, color: '#ef4444', status: 'warning' },
  { label: '院感事件', value: 0, icon: Activity, color: '#4ade80', status: 'normal' },
  { label: '设备故障', value: 1, icon: Wrench, color: '#fbbf24', status: 'warning' },
  { label: '投诉/建议', value: 2, icon: MessageSquare, color: '#3b82f6', status: 'info' },
]
      ...
      <div style={s.mainGrid}>
        ...
        <div style={s.panel}>
          ...
          <div style={s.callingCard}>
            ...
            <div style={s.callingPatient}>王芳</div>
            <div style={s.callingRoom}>诊室4 检查中</div>
          </div>
        ...
        <div style={s.panel}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginTop: 24 }}>
            <div style={{ textAlign: 'center', padding: 16, background: 'rgba(51, 65, 85, 0.5)', borderRadius: 8 }}>
              <div style={{ fontSize: 28, fontWeight: 800, color: '#4ade80' }}>487</div>
              <div style={{ fontSize: 12, color: '#64748b' }}>今日总检查</div>
            </div>
            <div style={{ textAlign: 'center', padding: 16, background: 'rgba(51, 65, 85, 0.5)', borderRadius: 8 }}>
              <div style={{ fontSize: 28, fontWeight: 800, color: '#3b82f6' }}>452</div>
              <div style={{ fontSize: 12, color: '#64748b' }}>昨日总检查</div>
            </div>
            <div style={{ textAlign: 'center', padding: 16, background: 'rgba(51, 65, 85, 0.5)', borderRadius: 8 }}>
              <div style={{ fontSize: 28, fontWeight: 800, color: '#4ade80' }}>+7.7%</div>
        ...
        <div style={s.panel}>
          ...
          <div style={{ marginTop: 20, padding: 16, background: 'rgba(51, 65, 85, 0.5)', borderRadius: 8 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: 24, fontWeight: 800, color: '#3b82f6' }}>486</div>
                <div style={{ fontSize: 11, color: '#64748b' }}>正常检查</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: 24, fontWeight: 800, color: '#fbbf24' }}>99.8%</div>
