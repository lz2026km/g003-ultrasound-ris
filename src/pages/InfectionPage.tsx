...
const generateInfectionCases = (): InfectionCase[] => [
  ...
  { id: 'INF002', patientName: '张丽华', patientId: 'P20240002', endoscope: 'CF-HQ290L(2号)', procedure: '浅表超声检查', infectionType: '艰难梭菌感染', severity: '中等', confirmedDate: '2024-01-18', department: '肛肠外科', doctor: '赵文博', status: '治愈', outcomes: '抗生素治疗有效', notes: '超声后3天出现腹泻' },
  { id: 'INF003', patientName: '李志刚', patientId: 'P20240003', endoscope: 'GIF-HQ290(1号)', procedure: 'USCP', infectionType: '胆道感染', severity: '重症', confirmedDate: '2024-01-22', department: '肝胆外科', doctor: '孙立群', status: '确诊', outcomes: '抗感染治疗中', notes: '术后发热，WBC升高' },
  ...
  { id: 'INF005', patientName: '刘德明', patientId: 'P20240005', endoscope: 'GIF-HQ290(1号)', procedure: '腹部超声+活检', infectionType: 'HP感染', severity: '轻症', confirmedDate: '2024-02-10', department: '消化内科', doctor: '李明华', status: '治愈', outcomes: '根除治疗成功', notes: '乙肝阳性，病理证实' },
  ...
  { id: 'INF010', patientName: '郑小红', patientId: 'P20240010', endoscope: 'CF-HQ290L(2号)', procedure: 'US_ABLATION', infectionType: '术后感染', severity: '轻症', confirmedDate: '2024-03-12', department: '肛肠外科', doctor: '赵文博', status: '治愈', outcomes: '抗生素治愈', notes: '术后2天切口红肿' },
  ...
  { id: 'INF012', patientName: '林婉如', patientId: 'P20240012', endoscope: 'JF-TF260(4号)', procedure: 'USCP+EST', infectionType: '急性胰腺炎', severity: '重症', confirmedDate: '2024-03-25', department: '肝胆外科', doctor: '王建华', status: '治愈', outcomes: '保守治疗成功', notes: '术后淀粉酶升高' },
  ...
  { id: 'INF016', patientName: '胡建军', patientId: 'P20240016', endoscope: 'JF-TF260(4号)', procedure: '小肠超声检查', infectionType: '小肠穿孔', severity: '危重', confirmedDate: '2024-04-20', department: '消化内科', doctor: '孙立群', status: '死亡', outcomes: '感染性休克', notes: '基础疾病：Crohn病' },
  ...
  { id: 'INF020', patientName: '冯桂英', patientId: 'P20240020', endoscope: 'CF-HQ290L(2号)', procedure: '浅表超声+US_ABLATION', infectionType: '盆腔脓肿', severity: '中等', confirmedDate: '2024-05-15', department: '肛肠外科', doctor: '赵文博', status: '治愈', outcomes: '穿刺引流后康复', notes: '术后持续发热' },
]
...
const generateOccupationalExposures = (): OccupationalExposure[] => [
  ...
  { id: 'EXP011', staffName: '黄志强', staffId: 'S20240011', department: '超声中心', exposureType: '黏膜暴露', sourcePatient: 'P20240018(HIV+)', exposureDate: '2024-04-05', exposureRoute: 'USCP操作', severity: '重度', immediateAction: '大量生理盐水冲洗眼结膜', reporter: '王建华', reportDate: '2024-04-05', status: '异常', hbvResult: '阴性', hcvResult: '阴性', hivResult: '待确认' },
